...
@powershell (new-object System.Net.WebClient).DownloadFile('https://raw.githubusercontent.com/chalvorson/sysmon-config/master/Auto_update.bat','C:\ProgramData\sysmon\Auto_Update.bat')"
